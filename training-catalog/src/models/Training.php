...
class Training {
     ...
     * @param string $location Lieu à rechercher
     * @return array Tableau des formations trouvées
     */
    public function searchByLocation($location) {
        try {
            ...
            error_log("Erreur lors de la recherche par lieu: " . $e->getMessage());
            throw new Exception("Impossible de rechercher les formations par lieu");
        }
    }
    
    /**
     * Récupère les formations par prix (fourchette)
    ...
    public function searchByPriceRange($minPrice, $maxPrice) {
        try {
            ...
            error_log("Erreur lors de la recherche par prix: " . $e->getMessage());
            throw new Exception("Impossible de rechercher les formations par prix");
        }
    }
}
?> 