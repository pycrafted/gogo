...
try {
    ...
    if (file_exists('database/catalog.db')) {
        unlink('database/catalog.db');
        echo "🗑️  Ancienne base de données supprimée\n";
    } else {
        echo "ℹ️  Aucune base de données existante à supprimer\n";
    }
